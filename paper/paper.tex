...
\todo[inline]{Add some background on subgraph isomorphism.}
...
Battiti and Mascia~\cite{battiti_algorithm_2007} were the first to propose
...
one target node $v$ such that for each neighbour $u'$ of $u$ there exists a
different neighbour $v'$
...
of variable-value assignments removed by LAD preprocessing in absolute terms, as
