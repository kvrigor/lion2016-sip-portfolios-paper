...
approach, and show that it is able to close more than 50\% of the gap between
the single best and the virtual best solver.
...
we are able to more than \SI{50}{\percent} of the gap between the single best and the virtual
best solver.
