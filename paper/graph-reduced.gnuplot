...
plot \
    "no-presolved-presolver.csv" u (strcol(2) eq "lad" ? $3 : NaN):($3 >= 1e8 ? 1e-10 : 1) smooth cumulative with lines notitle lc 1 dt ".", \
    "no-presolved-presolver.csv" u (strcol(2) eq "supplementallad" ? $3 : NaN):($3 >= 1e8 ? 1e-10 : 1) smooth cumulative with lines notitle lc 2 dt ".", \
    "no-presolved-presolver.csv" u (strcol(2) eq "vf2" ? $3 : NaN):($3 >= 1e8 ? 1e-10 : 1) smooth cumulative with lines notitle lc 4 dt ".", \
    "no-presolved-presolver.csv" u (strcol(2) eq "glasgow1" ? $3 : NaN):($3 >= 1e8 ? 1e-10 : 1) smooth cumulative with lines notitle lc 5 dt ".", \
...
plot \
    "no-presolved-presolver.csv" u (strcol(2) eq "lad" ? ($3<1e4?1e4:$3) : NaN):($3 >= 1e8 ? 1e-10 : 1) axes x1y2 smooth cumulative with lines notitle lc 1 dt ".", \
    "no-presolved-presolver.csv" u (strcol(2) eq "supplementallad" ? ($3<1e4?1e4:$3) : NaN):($3 >= 1e8 ? 1e-10 : 1) axes x1y2 smooth cumulative with lines notitle dt "." lc 2, \
    "no-presolved-presolver.csv" u (strcol(2) eq "glasgow1" ? ($3<1e4?1e4:$3) : NaN):($3 >= 1e8 ? 1e-10 : 1) axes x1y2 smooth cumulative with lines notitle dt "." lc 5, \
