...
pmod = mod$predictions
pmod$portfolio = parscores(ldf, mod, factor = 1)
pmod$iteration = NULL
pmod$algorithm = NULL
pmod$score = NULL
...
ggplot(wide, aes(x = time, col = solver)) + stat_ecdf() + scale_x_log10() +
...
pmod = mod$predictions
pmod$portfolio = parscores(ldf3, mod, factor = 1)
pmod$iteration = NULL
pmod$algorithm = NULL
pmod$score = NULL
...
pmod = mod$predictions
pmod$portfolio = parscores(ldf2, mod, factor = 1)
pmod$iteration = NULL
pmod$algorithm = NULL
pmod$score = NULL
