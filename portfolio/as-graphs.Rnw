...
ggplot(wide, aes(x = time, col = solver, linetype = type)) + stat_ecdf() +
    ...
    scale_x_log10(limits = c(10e-5, asscenario$desc$algorithm_cutoff_time)) +
    ylab("fraction of instances solved") +
    geom_vline(xintercept = asscenario$desc$algorithm_cutoff_time, col = "red")
@
...
tab = rbind(resvbs, ressb, resc, resr, rescp, resrp)
print(xtable(tab, digits = 3, caption = "Preliminary algorithm selection results with presolved instances removed."), booktabs = TRUE, include.rownames = FALSE)
@
...
tab = rbind(resvbs, ressb, resc, resr, rescp, resrp)
print(xtable(tab, digits = 3, caption = "Preliminary algorithm selection results with presolved instances removed (evaluated on all instances)."), booktabs = TRUE, include.rownames = FALSE)
@
...
tab = rbind(resvbs, ressb, resc, resr, rescp, resrp)
print(xtable(tab, digits = 3, caption = "Preliminary algorithm selection results with presolver (evaluated on all instances)."), booktabs = TRUE, include.rownames = FALSE)
@
